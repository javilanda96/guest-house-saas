...
- Exponer funciones de lectura/escritura de conversaciones y alertas para api.py.

La gestion de propiedades y knowledge base ha sido extraida a services/db_properties.py.
